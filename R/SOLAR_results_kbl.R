#' Title
#'
#' @param x A \code{data.frame} object as retrieved by `get_SOLAR_results`, which is a useful function to retrieve multiple-trait heritability. But in principle it works even with just 1 trait
...
#' 
function(x, padj_method = "BH", complete.cases = TRUE){
